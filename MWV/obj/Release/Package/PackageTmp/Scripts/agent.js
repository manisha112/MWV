        ...
        $.ajax(
               {
                   ...
                   success: function (data) {
                       ...
                       tmpddlOrders.html('');
                       tmpddlOrders.append($('<option>Select Purchase Order</option>'));
                       $.each(data, function (id, option) {

                           tmpddlOrders.append($('<option>Select Purchase Order</option>').val(option.id).html((option.id) + ", " + option.name));
    ...
    $.ajax(
                 {
                     cache: false,
                     type: "POST",
                     url: "/Agent/AgentBackToDashboard/",
                     contentType: "application/json; charset=utf-8",
                     success: function (data) {
